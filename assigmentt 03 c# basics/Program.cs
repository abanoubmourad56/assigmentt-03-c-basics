...
namespace assigmentt_03_c__basics
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //18.Using the same books array, loop through it and print each title, but stop completely (break) once you reach "Refactoring
            //foreach (string book in books)
            //{
            //    if (book == "Refactoring")
            //    {
            ...
            //19. Using the same books array, print every title except "The Pragmatic Programmer" (skip it with continue, don't stop the loop)
            //foreach (string book in books)
            //{
